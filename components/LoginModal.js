...
export default function LoginModal({ show, handler, csrfToken }) {
  ...
  return (
    <>
      <div
        className={
          "fixed top-1/2 left-1/2 w-96 p-4 rounded bg-white transform -translate-x-1/2 -translate-y-1/2 transition-all duration-150 "
      ...
      >
        <div className="flex flex-col items-center w-full text-lg">
          ...
          <div className="mt-4">
            ...
            />
            <button
              className="w-full mt-4 py-1 rounded bg-accent-primary font-semibold text-white"
