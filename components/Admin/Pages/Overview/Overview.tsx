  ...
  const toggleSelectAllUsers = (selectAll: boolean) => {
    ...
    if (selectAll) {
      if (selectedView === 'All Users') {
        ...
        setSelectedUsers(data.users.filter(user => user.qualified === 'yes'))
      }
      else if (selectedView === 'Rejected') {
        setSelectedUsers(data.users.filter(user => user.qualified === 'no'))
      }
      else if (selectedView === 'Checked-In') {
        setSelectedUsers(data.users.filter(user => user.qualified === 'yes' && user.checkedIn))
      }
