...
export function UserActions({
  ...
  const remindToApply = (users) => {
    axios.post('/api/apps/remind-apply', { users })
    .then(() => {
      toast.success(
  ...
  const remindToJoinDiscord = (users) => {
    axios.post('/api/apps/remind-discord', { users })
    .then(() => {
      toast.success(
        'Successfully sent reminders!',
  ...
  const remindToCheckIn = (users) => {
    axios.post('/api/apps/remind-checkin', { users })
    .then(() => {
      toast.success(
        'Successfully sent reminders!',
  ...
  const autoDecideSelected = (users) => {
    axios.post('/api/apps/auto-review', { users })
    .then(() => {
      toast.success(
  ...
  const approveSelected = (users, approved) => {
    axios.post('/api/apps/manual-review', { users, approved })
    .then(() => {
      toast.success(
  ...
  const redoApproveSelected = (users) => {
    axios.post('/api/apps/re-review', { users })
    .then(() => {
      toast.success(
        'Approved selected successfully!',
